  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 page-content">
        <h1>Transport with Bus route</h1>
        <div class="page_nav">
          <span>You are here:</span> <a href="<?php echo base_url() ?>">Home</a> <span><i class="fa fa-angle-double-right"></i>Transport with Bus route</span>
        </div>
      </div>
    </div>
  </div>
