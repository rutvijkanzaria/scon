	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 page-content">
				...
				<div class="page_nav">
			<span>You are here:</span> <a href="./">Home</a> <span><i class="fa fa-angle-double-right"></i>Obstetrics and Gynaecological Nursing</span>
			</div>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-sm-offset-1 col-sm-10 course_detail wow fadeIn" data-wow-delay="400ms">
				...
				<div class="profile_border">
					<div class="top20 bottom20">
						<div class="profile_text">
							<h3><strong>Hands on training – Simulation Lab</strong></h3>
