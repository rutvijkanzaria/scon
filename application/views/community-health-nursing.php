	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 page-content">
				...
				<p>The department has been promoting the knowledge of Community Health Nursing that will ensure competence in working at the different levels of health care arena in community.</p>
				<div class="page_nav">
			<span>You are here:</span> <a href="<?php echo base_url() ?>">Home</a> <span><i class="fa fa-angle-double-right"></i>Community Health Nursing</span>
			</div>
			</div>
		</div>
	</div>
