  ...
  <div id="rev_slider" class="rev_slider"  data-version="5.0">
    ...
    <!-- SLIDE  -->
      <li data-transition="fade">
        ...
        data-start="1500"><!--<img src="<?php echo base_url()?>/images/sconlogo.png">-->
        </div>
        <!-- <div class="tp-caption  tp-resizeme"
        data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
      ...
      <li data-transition="fade">
        ...
        data-transform_out="y:[100%];s:1000;e:Power2.easeInOut;s:1000;e:Power2.easeInOut;"
        data-mask_out="x:inherit;y:inherit;s:inherit;e:inherit;"
        data-start="800"><!--<img src="<?php echo base_url()?>/images/sconlogo.png">-->
        </div>
        <div class="tp-caption tp-resizeme"
        data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
        data-y="['380','340','300','350']" data-voffset="['0','0','0','0']"
        ...
        data-transform_in="opacity:0;s:1000;e:Power2.easeInOut;"
        data-transform_out="opacity:0;s:1000;s:1000;"
        data-start="1500"><!--<p>Your chance to be an expert in the industry and make a successful <br/> career after completion of our courses.</p>-->
        </div>
        <!-- <div class="tp-caption  tp-resizeme"
        data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
        data-y="['450','390','350','250']" data-voffset="['0','0','0','0']"
