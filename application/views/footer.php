  ...
  <div class="container">
    <div class="row">
      <div class="col-md-4 col-sm-4 footer_panel bottom25">
        ...
        <p>SCON is an evolving organization which will prepare competent professional graduate nurses for diverse health care delivery and leadership roles.</p>
...
<script src="<?php echo base_url() ?>js/jquery-2.2.3.js"></script>
...
<script src="<?php echo base_url() ?>js/jquery.cubeportfolio.min.js"></script>
